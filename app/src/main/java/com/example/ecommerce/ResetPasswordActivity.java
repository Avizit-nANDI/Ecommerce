...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private void setAnswers(){
        ...
        if(question1.equals("")&&question2.equals("")){
            ...
            databaseReference.child("Security Questions").updateChildren(userdataMap)
                    ...
                    if(snapshot.exists()){
                        ...
                        if(snapshot.hasChild("Security Questions")){
                            ...
                            if(!ans1.equals(answer1)){
                                ...
                                Toast.makeText(ResetPasswordActivity.this, "your 1st ans is worng", Toast.LENGTH_SHORT).show();
                            }else if(!ans2.equals(answer2)){
                                Toast.makeText(ResetPasswordActivity.this, "your 2nd ans is worng", Toast.LENGTH_SHORT).show();
                            }else{
